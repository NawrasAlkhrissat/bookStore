...
<body>
    ...
    <div class="edit-book-form">
            ...
            <form action="../controller/editBook.php" method="post">
                ...
                <input type="number" name="quantity" placeholder="Total Quantity" value="<?= $row['quantity'] ?>" required min="1">
                <input type="number" name="available_quantity" placeholder="Available Quantity" value="<?= $row['available_quantity'] ?>" required min="0">
                <input type="number" name="published_year" placeholder="Published Year" value="<?= $row['published_year'] ?>" required min="1600" max="2155">
